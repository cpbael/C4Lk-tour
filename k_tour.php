<?php
	function printSol(){
		...
		/* INITIALIZE AND PRINT CHESSBOARD */
		$solution = array(
		...
		<section id="posts">
			<article>
				<form action="solver.php" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="Generate" value="Generate Solution" id="Generate">
					<p>Output:</p>
				</form>

				<form action="printOutput.php" method="POST" enctype="mulitpart/form-data">
					<input type="submit" name="Print" value="Print Solution">

					<!-- Check if hindi null yung napass sa session -->
				</form>
